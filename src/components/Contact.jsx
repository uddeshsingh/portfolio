      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-5xl relative z-10">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-12 max-w-md leading-relaxed">
              I am currently open to discussing full-stack roles, cloud
              architecture projects, or AI collaborations.
            </p>
            <div className="flex flex-col gap-8">
              <ContactItem
                icon={<Mail size={24} />}
                label="Email Frequency"
                value="uxs230004@utdallas.edu"
                href="mailto:uxs230004@utdallas.edu"
              />
              <ContactItem
                icon={<MapPin size={24} />}
                label="Base Station"
                value="Dallas, TX, United States"
              />
        ...
        <div className="relative">
          <motion.div
            ...
            className="glass-panel relative p-8 rounded-3xl overflow-hidden group bg-white/5"
          >
            {/* Corners */}
            <CornerStyles />
...
const ContactItem = ({ icon, label, value, href }) => (
  <div className="flex items-center gap-4 group cursor-default">
    <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex-center text-[--neon-blue] group-hover:bg-[--neon-blue] group-hover:text-black transition-colors duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)]">
      {icon}
    </div>
    <div>
      ...
      {href ? (
        <a
          href={href}
          className="text-lg text-white font-medium hover:text-[--neon-blue] transition-colors"
        >
          {value}
        </a>
      ) : (
...
const InputGroup = ({ label, placeholder, type = "text", textarea }) => (
  <div className="flex flex-col gap-2 group">
    <label className="text-xs font-mono text-[--neon-blue]/80 uppercase tracking-wider ml-1 group-focus-within:text-[--neon-blue] transition-colors">
      {label}
    </label>
    {textarea ? (
      <textarea
...
const SuccessMessage = () => (
  <motion.div
    ...
    className="h-[400px] flex-center flex-col text-center p-6"
  >
    <div className="w-20 h-20 rounded-full bg-green-500/20 text-green-400 flex-center mb-6 shadow-[0_0_30px_rgba(34,197,94,0.3)]">
    ...
    <p className="text-gray-400">
      Your signal has been locked in. I'll re-establish communication shortly.
    </p>
  </motion.div>
);
